...
Use of a GPU or AI accelerator such as a [Google Coral](https://coral.ai/products/), [Hailo](https://hailo.ai/), or [MemryX](https://memryx.com) is highly recommended. AI accelerators will outperform even the best CPUs with very little overhead.
